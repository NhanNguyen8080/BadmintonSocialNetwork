...
{
    /// <inheritdoc />
    public partial class createFriendClubandClubMembertablesandaddPostVisibilycolumninPosttable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_Accounts_AddresseeId",
                        column: x => x.AddresseeId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friends_Accounts_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubMembers", x => new { x.ClubId, x.AccountId });
                    table.ForeignKey(
                        name: "FK_ClubMembers_Accounts_AccountId",
